...
program against nursing facilities (NF), assisted living facilities (ALF), and residential
 ...
 2015 and 2016. [(Data)](https://github.com/TheOregonian/long-term-care-db/blob/master/data/processed/complaints-3-29-scrape.csv)
   ...
   d) All complaints the department had posted on its searchable database of substantiated 
      ...
      The data were scraped using [this Python code.](https://github.com/TheOregonian/long-term-care-db/blob/master/scraper/DHS_scraper.py)  
...
with characteristics and complaint counts. [(Data)](https://github.com/TheOregonian/long-term-care-db/blob/master/data/processed/facilities-3-29-scrape.csv)
